...
def heart_rate_estimation(sequence, sr=400):
    ...
    interval = candidate_set[close_index + 2] - candidate_set[close_index]
    coarse_template = [candidate_set[close_index],  candidate_set[close_index + 2]]
    ...
    peaks_correlation, property = scipy.signal.find_peaks(correlation, height=0.6, distance=10, width=1)
